          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <div class="space-y-4 md:space-y-6">
              ...
              <div class="flex items-center justify-center">
                <button :disbabled="auth.form.disabled" @click="auth.SendLogin()" type="button" class="text-white bg-green-500 hover:bg-green-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-green-500 focus:outline-none dark:focus:ring-blue-800">
